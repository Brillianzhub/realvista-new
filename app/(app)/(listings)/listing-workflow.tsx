...
import {
  ...
  isBackendListing,
} from '@/utils/market/marketplaceMapper';
...
export default function ListingWorkflowScreen() {
  ...
  const property = portfolioProperty
    ? JSON.parse(portfolioProperty as string)
    : null;
      ...
      >
        {listing?.thumbnail_url && (
          <View style={styles.propertyPreview}>
            ...
            <View style={styles.propertyInfo}>
              <Text
                style={[styles.propertyName, isDark && styles.propertyNameDark]}
              >
                {listing?.property_name}
              </Text>
              <Text
                style={[
                  ...
                  isDark && styles.propertyLocationDark,
                ]}
              >
                {listing?.location}
              </Text>
        ...
        <View style={[styles.progressCard, isDark && styles.progressCardDark]}>
          <View style={styles.progressHeader}>
            <Text
              style={[styles.progressTitle, isDark && styles.progressTitleDark]}
            >
              Overall Progress
            </Text>
            <View
              style={[
                ...
                {
                  backgroundColor:
                    progressPercentage === 100 ? '#10B981' : '#FB902E',
                },
              ]}
            >
          ...
          >
            {progressPercentage === 100
              ? 'All steps completed!'
              : `${steps.length - completedSteps} step${
                  steps.length - completedSteps !== 1 ? 's' : ''
                } remaining`}
          </Text>
        </View>
      </LinearGradient>
          ...
          >
            ...
            <View style={styles.stepContent}>
              <View style={styles.stepHeader}>
                <Text
                  style={[styles.stepTitle, isDark && styles.stepTitleDark]}
                >
                  {step.title}
                </Text>
                {step.completed && (
            ...
            <Ionicons
              ...
              size={24}
              color={
                step.completed ? '#10B981' : isDark ? '#6B7280' : '#9CA3AF'
              }
            />
          </TouchableOpacity>
        ))}
