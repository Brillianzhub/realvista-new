...
export default function PropertyValueEstimatorScreen() {
  ...
  const validateForm = (): boolean => {
    ...
    if (
      ...
      (!formData.bedrooms || parseInt(formData.bedrooms) <= 0)
    ) {
      ...
      <View style={styles.content}>
        ...
        >
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              onChangeText={(value) =>
                handleInputChange('additionalFeatures', value)
              }
            />
          </View>
          ...
          <TouchableOpacity
            style={[
              ...
              isCalculating && styles.estimateButtonDisabled,
            ]}
          ...
          <View style={styles.resultSection}>
            ...
            <View style={styles.disclaimer}>
              ...
              <Text style={styles.disclaimerText}>
                Note: This is an AI-based estimate. Actual value may vary based
                on market conditions, property specifics, and location factors.
              </Text>
            </View>
          </View>
        )}
        ...
        >
          <View style={styles.consultationHeader}>
            <Ionicons name="people" size={28} color={colors.icon.default} />
            <Text
              style={[styles.consultationTitle, { color: colors.text.primary }]}
            >
              Need Professional Valuation?
            </Text>
          </View>
          <Text
            style={[styles.consultationText, { color: colors.text.secondary }]}
          >
            Get an accurate, certified property valuation from our expert team
            at RealVista
          </Text>
          <View style={styles.contactButtons}>
            ...
            >
              ...
              <View style={styles.contactButtonContent}>
                ...
                <Text style={styles.contactButtonValue}>
