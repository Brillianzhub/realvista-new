...
export default function SavingsTab() {
  ...
  const handleDeleteTarget = async (targetId: number) => {
    Alert.alert(
      'Delete Target',
      'Are you sure you want to delete this savings target?',
      [
                ...
                >
                  ...
                  <View style={styles.progressContainer}>
                    ...
                    >
                      <LinearGradient
                        ...
                        style={[
                          styles.progressFill,
                          { width: `${target.progress_percentage}%` },
                        ]}
                      />
                    </View>
                    <Text
                  ...
                  <View style={styles.targetFooter}>
                    <View style={styles.footerItem}>
                      ...
                      >
                        {target.months_remaining}{' '}
                        {target.months_remaining === 1 ? 'month' : 'months'}{' '}
                        left
                      </Text>
                    </View>
                    ...
                    >
                      ...
                      >
                        <Ionicons
                          ...
                          color="#FFFFFF"
                        />
                        <Text style={styles.addContributionText}>
                          Add Contribution
                        </Text>
                      </LinearGradient>
                    </TouchableOpacity>
