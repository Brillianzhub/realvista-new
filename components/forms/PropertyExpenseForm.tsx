...
const PropertyExpenseForm: React.FC<PropertyExpenseFormProps> = ({ onSubmit }) => {
            ...
            >
                ...
                <View style={styles.formGroup}>
                    ...
                    <TextInput
                        ...
                        placeholder="Maintenance, repairs, utilities..."
                        placeholderTextColor={isDark ? '#9CA3AF' : '#6B7280'}
                ...
                <View style={styles.formGroup}>
                    <Text style={[styles.label, isDark && styles.labelDark]}>
                        Date Incurred <Text style={styles.required}>*</Text>
                    </Text>
                    <TouchableOpacity
                        style={[
                            styles.dateButton,
                            isDark && styles.dateButtonDark,
                            errors.date_incurred && styles.inputError
                        ]}
                    ...
                    >
                        ...
                        <Text
                            style={[
                                ...
                                !formData.date_incurred && styles.placeholderText
                            ]}
                        >
                            {formData.date_incurred
                                ? `Date: ${formData.date_incurred}`
