  ...
  return (
    ...
    >
      <View style={styles.titleRow}>
        ...
        >
          <ListFilterPlus size={22} color={colors.icon.default} />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.tabContainer}>
        <TouchableOpacity
          style={[
            styles.tabButton,
            marketType === 'traditional' && styles.activeTab,
          ]}
        ...
        >
          <Text
            style={[
              ...
              marketType === 'traditional' && styles.activeTabText,
            ]}
          >
            Coporate Listings
          </Text>
        ...
        >
          <Text
            style={[
              styles.tabButtonText,
              marketType === 'p2p' && styles.activeTabText,
            ]}
          >
            P2P
          </Text>
