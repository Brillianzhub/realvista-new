    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Text style={[styles.modalHeader, { color: colors.text.primary }]}>
              Why Contact Preferences Matter
            </Text>
            <Text style={[styles.modalBody, { color: colors.text.primary }]}>
              Contact preferences determine how potential buyers or tenants can
              reach you. By default, all permissions are set to "off" to
              prioritize your privacy. Adjusting these settings is important if
              you have properties listed for sale or rent on the platform.
              {'\n\n'}
              If you don't have any properties listed, you don't need to worry
              about contact preferences, as they won't affect your account.{' '}
              Ensuring these settings reflect your needs will help align
              communication preferences with your goals and privacy.
            </Text>
            <Pressable
