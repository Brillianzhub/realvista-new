...
const PortfolioMediaGallery: React.FC<PortfolioMediaGalleryProps> = ({ 
    ...
    const handleDeleteFile = async (fileId: number, fileType: 'image' | 'video'): Promise<void> => {
    ...
    const confirmDeleteFile = async (fileId: number, fileType: 'image' | 'video'): Promise<void> => {
        setIsDeleting(true);
        ...
        try {
            ...
            if (response.ok) {
                ...
                Alert.alert('Not Found', 'The file you are trying to delete does not exist.');
            } else {
                    ...
                    <View style={styles.modalContainer}>
                        <View style={styles.modalHeader}>
                            ...
                            {canDeleteFile() && currentMedia && (
                                <TouchableOpacity 
                                    onPress={() => handleDeleteFile(currentMedia.id, currentMedia.file_type)}
